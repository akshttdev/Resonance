...
-- CreateEnum
CREATE TYPE "VoiceCategory" AS ENUM ('AudioBook', 'Conversational', 'CustomerService', 'General', 'Narrative', 'Characters', 'Meditation', 'Motivational', 'Podcast', 'Advertising', 'VoiceOver', 'Corporate');
...
CREATE TABLE "Generation" (
    ...
    "repitionPenalty" DOUBLE PRECISION NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
